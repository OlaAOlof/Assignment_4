...
# eval = FALSE gjør vi for å hindre at vi ved et uhell henter inn dataene på nytt (som i prinsippet kan ha endret seg hvis SSB oppdaterer statistikken).
...
Data sist hentet 18. november 2021 Dette dokumentet skal bare kjøres hvis nye data må hentes inn. `eval = FALSE` over i setup chunk må endres til `eval = TRUE`, så må setup chunk-en kjøres før en til slutt velger  `Restart R and run all chunks` fra `Run` menyen.
...
arbl_p_alder <- ApiData(
    http://www.ssb.no/statbank/sq/10059717,
    Region = kom_vec,
    Tid = tid_vec,
    Alder = alder_vec
  )
